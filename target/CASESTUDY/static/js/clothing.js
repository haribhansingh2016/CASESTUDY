var employees ;
	$.getJSON("http://localhost:8080/CASESTUDY/json/clothes", function(json){
		employees = json;
	});
$(document).ready(function(){
	...
	txt+="<div class=\"img\" id=id"+employees[i].productId+">\
	      <a  href=  \"product.html?id="+employees[i].productId+"\"><img src=../images/"+employees[i].imageSrc+"><div class=\"desc\">"+employees[i].name+"</div></a>\
